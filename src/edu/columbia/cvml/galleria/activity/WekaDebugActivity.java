...
public class WekaDebugActivity extends Activity implements AsyncTaskRequestResponse {

	String LOG_TAG =  "wekaDebugActivity";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_debug);
		
		Toast.makeText(getApplicationContext(), "Entering WekaDebugActivity", Toast.LENGTH_LONG).show();;
	...
	private void isMyServiceRunning() {
	    ...
	    for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
	    	...
	    	if (ImageDetectorService.class.getName().equals(service.service.getClassName())) {
				...
				Toast.makeText(WekaDebugActivity.this,"Service is running", Toast.LENGTH_LONG).show();
	        }
	    }
	}
	...
	private void uploadImage(String img_name)
	{
		...
		try {
			...
			TextView text = (TextView) findViewById(R.id.annotations);
			Toast.makeText(WekaDebugActivity.this,"Annotating in progress... Please wait...", Toast.LENGTH_LONG).show();
	...
	{         
		...
		case R.id.MainScreen:
			Toast.makeText(WekaDebugActivity.this, "Main Screen is selected", Toast.LENGTH_SHORT).show();
			Intent intent = new Intent(WekaDebugActivity.this, MainActivity.class);
