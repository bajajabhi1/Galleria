package edu.columbia.cvml.galleria.carousel;
/*
...
public class CarouselView extends Gallery {
    ...
    protected boolean getChildStaticTransformation(View child, Transformation t) {
     ...
     private void transformImageBitmap(CarouselViewItem s, Transformation t, int rotationAngle) {            
    	...
    	// ScalableImageView s = (ScalableImageView)child;
    	 
    	 final int imageWidth = s.getMaxW();//child.getLayoutParams().height;;
    	 final int imageHeight = s.getMaxH();//child.getLayoutParams().width;
    	 //Log.e("db", "transformImageBitmap:" +imageWidth + ":"+imageHeight + "::" + s.getMaxW()+"x"+s.getMaxH());
